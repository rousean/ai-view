...
export class EventBus {
  ...
  on<K extends EditorEventKey>(event: K, handler: Listener<EditorEventMap[K]>): () => void
  ...
  once<K extends EditorEventKey>(event: K, handler: Listener<EditorEventMap[K]>): () => void {
