...
export type BeforeHandler<T> = (payload: ChangePayload<T>) => T | false
...
export class HookManager {
  ...
  beforeChange<T>(target: ChangeTarget, handler: BeforeHandler<T>): () => void {
  ...
  afterChange<T>(target: ChangeTarget, handler: AfterHandler<T>): () => void {
