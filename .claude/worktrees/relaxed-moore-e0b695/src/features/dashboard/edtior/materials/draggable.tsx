...
export default function Draggable({ meta }: { meta: Meta }) {
  ...
  return (
    <div ref={ref} className="flex justify-center items-center gap-2 border border-gray-200 rounded-md bg-accent cursor-grab active:cursor-grabbing transition-all overflow-hidden">
